...
(function () {
  ...
  /** 多角色配置 */
  var ROLES = {
    youth: { label: '心青年', name: '小雨', avatar: '🌻', color: '#D97757',
      canAdd: ['mood', 'note'],
    ...
    caregiver: { label: '影子老师', name: '张阿姨', avatar: '🤝', color: '#F5E6D3',
      canAdd: ['care', 'communication', 'emotion', 'strategy', 'note'],
  ...
  /**
   * 不显示底部导航的页面（子页面/详情页）—— 只保留顶部返回按钮
   */
  var HIDE_BOTTOM_NAV = [
    'timeline', 'records', 'quickcard',
    'life', 'communication', 'emotion', 'care', 'work', 'relations',
    'chat-conversation', 'chat-review', 'youth-chat',
    'quick-record', 'draft-review',
    'archive-code', 'batch-import',
    'grants', 'join', 'approvals',
    'admin-users', 'admin-data'
  ];
  ...
  /** 信息来源类型 */
  var SOURCE_TYPES = {
    selfReported: { key: 'self', label: '心青年自己说的', icon: '💬', color: '#D97757', desc: '本人通过对话或表达直接传递的信息' },
    observerReported: { key: 'observer', label: '支持者观察到的', icon: '👁️', color: '#F5E6D3', desc: '家长、老师等照护者基于观察记录的信息' },
  ...
  var demoWorkflow = {
    ...
    steps: [
      { step: 1, actor: '心青年·小雨', action: '在对话端表达："明天不想去新的工作地点。"', icon: '💬', color: '#D97757' },
      { step: 2, actor: 'AI懂我', action: '通过简短追问理解原因：是因为之前没去过、不知道路怎么走、还是担心那里的人不认识？', icon: '🤖', color: '#F5E6D3' },
      ...
      { step: 5, actor: 'AI懂我', action: 'AI 分析发现：近4次涉及"新环境"的记录中，有3次使用了"提前展示照片+路线图"，焦虑持续时间平均缩短70%。建议将此方法沉淀为小雨的"新环境适应策略"。', icon: '🤖', color: '#F5E6D3' },
